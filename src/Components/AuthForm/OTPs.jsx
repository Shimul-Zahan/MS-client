        ...
        <>
            <section className='w-full min-h-screen mx-auto py-10'>
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
                    <h1 className="text-3xl font-bold text-center text-indigo-600 py-2">OTP Verification</h1>
                    {/* Input fields and the form started */}
                    <form onSubmit={handleOtp} className="space-y-7">
                        <div className="space-y-2 text-sm">
                            <div className='relative'>
                                <input type="text" name="otp" id="otp" placeholder="OTP" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring" />
                                <svg className='absolute top-1/2 -translate-y-1/2 right-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
