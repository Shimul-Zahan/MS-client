        ...
        <Link to={path}>
            <div className={`min-w-[300px] relative bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-between`}>
                ...
                <div className="p-5">
                    ...
                    <p className="mb-3 font-normal text-xl text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order. in reverse chronological order. Good bye tata</p>
